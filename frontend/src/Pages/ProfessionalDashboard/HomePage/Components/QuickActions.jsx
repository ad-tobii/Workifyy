    ...
    <div className="scrollbar-hide mt-6 w-[90%] overflow-x-auto">
      ...
      <div className="no-scrollbar overflow-x-auto">
        <div className="flex space-x-4">
          {/* Find Jobs */}
          <div className="flex h-20 w-24 flex-col items-center justify-center rounded-xl bg-[#242427]/80 text-white backdrop-blur-md transition-all duration-200 active:scale-95">
          ...
          {/* Post Job */}
          <div className="flex h-20 w-24 flex-col items-center justify-center rounded-xl bg-[#32cd32]/15 text-white backdrop-blur-md transition-all duration-200 active:scale-95">
