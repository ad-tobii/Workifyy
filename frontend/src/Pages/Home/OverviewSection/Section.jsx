...
function Section() {
  return (
    <div className="mt-28 flex flex-col items-center gap-10 px-10 largeDesktop:flex-row largeDesktop:justify-center">
      <div>
        <img
          src="/assets/workers-svg.svg"
          className="vecimg xsMobile:mt-6 xsMobile:w-[15rem] miniMobile:w-[20rem] mobile:w-[25rem] miniTablet:w-[20rem] tablet:w-[30rem] miniLaptop:w-[25rem] laptop:w-[35rem] desktop:w-[35rem] largeDesktop:w-[30rem]"
          alt=""
        />
      </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="max-w-sm text-sm text-[#32CD32]">
                No stress, no charge. Sign up and discover skilled professionals who are ready to
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="max-w-sm text-sm text-[#32CD32]">
                Finding professionals doesn’t have to be a chore. Post your job, compare bids, and
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold">Quality Work, Friendly Prices</h2>
              <p className="max-w-sm text-sm text-[#32CD32]">
                Work with verified professionals at rates you can afford. No hidden fees, no
                surprises—just the right price for the right job.
              </p>
            </div>
          </div>
        </div>
